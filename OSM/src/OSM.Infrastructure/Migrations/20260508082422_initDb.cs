        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuShortName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    MenuType = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    MenuGroup = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    MenuUrl = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    IconIndex = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PermissionId = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    RoleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PermissionId = table.Column<string>(type: "nvarchar(150)", nullable: false),
                    MenuId = table.Column<string>(type: "nvarchar(50)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleMenuPermission", x => new { x.RoleId, x.MenuId, x.PermissionId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Permissions",
                columns: new[] { "PermissionId", "Description" },
                values: new object[,]
                {
                    { "delete", "Delete" },
                    { "read", "Read" },
